...
void test_yaml() {
    YAML::Node root = YAML::LoadFile("/home/bread/workspace/awesome-sylar/bin/conf/log.yml");
    //print_yaml(root, 0);
...
#define XX_M(g_var, name, prefix) \
    ...
    YAML::Node root = YAML::LoadFile("/home/bread/workspace/awesome-sylar/bin/conf/test.yml");
